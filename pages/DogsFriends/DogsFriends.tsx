...
const DogsFriends = ({ sanityDogsFriends }: any) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <SEO
        title="Lazy Dog Friends"
        description="The Lazy Dog Company has many dog friends. When we make our blankets and duvets we always think that they are the ones who have to be happy!"
      />
